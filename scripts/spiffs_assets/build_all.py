...
def build_assets(wakenet_model, text_font, emoji_collection, target_board, build_dir, final_dir):
    ...
    print(f"\N is building: {wakenet_model}-{text_font}-{emoji_collection}-{target_board}")
...
def main():
    ...
    parser = argparse.ArgumentParser(description='Build multiple SPIFFS assets Partition')
    parser.add_argument('--mode',
                       choices=['emoji_collections', 'emoji_target_boards'],
                       default='emoji_collections',
                       help='Select operating mode: emoji_collections or emoji_target_boards (default: emoji_collections)')
    ...
    print("Start building multiple SPIFFS assets Partition...")
    ...
    print(f"\n build completed!")
    print(f"Build successfully: {successful_builds}/{total_combinations}")
    ...
    if os.path.exists(final_dir):
        ...
        if files:
            ...
            print("\nGenerated not found .bin document")
